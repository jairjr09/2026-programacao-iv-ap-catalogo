...
# restaura as depêndencias NuGet do projeto antes de compilar
# para aproveitar o cache de camadas o docker acelera o build
RUN dotnet build "./umfgcloud.loja.webapi/umfgcloud.lojawebapi.csproj"
COPY ..

# definir a pasta de trabalho do container
# compilar o projeto no modo configurado anteriormente (Release)
WORKDIR "/src/umfgcloud.loja.webapi/umfgcloud.lojawebapi.csproj"
...
RUN dotnet publish "./umfgcloud.loja.webapi.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
