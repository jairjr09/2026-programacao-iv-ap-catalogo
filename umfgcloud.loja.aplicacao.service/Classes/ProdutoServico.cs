...
namespace umfgcloud.loja.aplicacao.service.Classes
{
    public class ProdutoServico : AbstractServico, IProdutoServico
    {
        ...
        public ProdutoServico(IHttpContextAccessor httpContextAccessor, IProdutoRepositorio repositorio) : base(httpContextAccessor)
        {
        ...
        // só consegue fazer a conversão de atributos públicos na classe destino e ICollection
