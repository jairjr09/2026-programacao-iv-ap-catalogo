...
namespace umfgcloud.loja.aplicacao.service.Classes
{
    ...
    {   
            ...
            IOptions<JwtOptions> jwtOptions)
        {
            ...
            _jwtOptions = jwtOptions?.Value ?? throw new ArgumentNullException(nameof(userManager));
        }

        public async Task<UsuarioDTO.SignInResponse> AutenticarAsync(UsuarioDTO.SingInRequest dto)
        {
            ...
            return new UsuarioDTO.SignInResponse()
            {
